...
macro_rules! __export_squarer_impl {
...
#[doc(inline)]
pub(crate) use __export_squarer_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:squarer:encoded world"]
#[doc(hidden)]
...
B\x02\x01@\x01\x01ay\0y\x04\0\x06square\x01\0\x04\x01\x1cdocs:calculator/square@\
0.1.0\x05\0\x04\x01\x1ddocs:calculator/squarer@0.1.0\x04\0\x0b\x0d\x01\0\x07squa\
rer\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.201.0\x10\
